...
<p><a title="View the chart" href="https://westonruter.github.io/ipa-chart/"><img src="screenshot.png" width="320" alt="Screenshot of the IPA Chart"></a></p>
...
<p><a href="https://westonruter.github.io/ipa-chart/">View the chart →</a></p>
<p>Additionally, I’ve also built an <a href="https://westonruter.github.io/ipa-chart/keyboard/">IPA “keyboard”</a> off of the chart in order to facilitate copying the Unicode symbols and making transcriptions. It keeps track of recently used symbols and allows you to insert the symbols encoded in HTML entities. <em>It works best in <a href="http://www.getfirefox.com/">Firefox</a></em> and <a href="http://opera.com/">Opera 9+</a>, 			but also works in Internet Explorer 6 (but not in version 5).</p>
<p><a href="https://westonruter.github.io/ipa-chart/keyboard/">View the “keyboard” →</a></p>

Changelog
=========

See [old changelog](https://westonruter.github.io/ipa-chart/changelog-old.html) for previous changes.
